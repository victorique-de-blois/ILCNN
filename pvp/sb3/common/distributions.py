...
from pvp.sb3.common.preprocessing import get_action_dim
...
class DiagGaussianDistribution(Distribution):
    ...
    def proba_distribution_net(self,
                               ...
                               fixed_log_std=False) -> Tuple[nn.Module, nn.Parameter]:
        """
        ...
        log_std = nn.Parameter(
            th.ones(self.action_dim) * log_std_init, requires_grad=True if not fixed_log_std else False
        )
