...
from pvp.sb3.ppo.policies import ActorCriticCnnPolicy as ActorCriticPolicy
...
if __name__ == '__main__':
    ...
    parser.add_argument("--wandb_project", type=str, default="PPO_CNN", help="The project name for wandb.")
